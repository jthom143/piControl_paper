function [ time_year, jet_DJF, lat_jet_DJF, jet_trend, jet_trend_30, jet_loc_trend, jet_loc_trend_30 ] = MPI_ESM_LR_historical_u850
...
%% Import Data
current_path = pwd;
pathname_u850 = fullfile(current_path, 'HistoricalData/MPI_ESM_LR_historical_u850.cdf');     % CDF file from Lamont website
