function [ jet_mon, lat_jet_mon, y_mon, jet_ann, lat_jet_ann ] = taux_findmax_ncep_new( taux_mon,  lat, time_month )
...
taux_mon = taux_mon(:,lat_0:lat_90,:);
lat = lat(lat_0:lat_90);
...
for i = 1:length(time_month)
    lat_new(:,i) = lat(upper_bound(i)):0.1:lat(lower_bound(i));
