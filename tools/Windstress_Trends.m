function [ jet_f, jet_xi, mean_jet, std_jet, jet_trends_yrs, jet_loc_f, jet_loc_xi, mean_jet_loc, std_jet_loc, jet_loc_trends_yrs] = Windstress_Trends( time_year, jet, jet_loc, trend_period, trend_length )
...
[jet_loc_f, jet_loc_xi] = ksdensity(jet_loc_trends_yrs, 'width', bw,'function','pdf');
