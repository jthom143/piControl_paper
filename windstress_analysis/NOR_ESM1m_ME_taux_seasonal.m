function [ jet_f, jet_xi, mean_jet, std_jet, jet_trends_yrs, jet_loc_f, jet_loc_xi, mean_jet_loc, std_jet_loc, jet_loc_trends_yrs, time_year, jet_DJF, lat_jet_DJF ] = NOR_ESM1m_ME_taux_seasonal
...
%% Import Data
% current_path = pwd;
% pathname_taux = fullfile(current_path, 'piControlData/NOR_ESM1m_ME_taux.cdf');     % CDF file from Lamont website
% pathname_coord = fullfile(current_path, 'piControlData/NorESM1-ME_tauuo_Omon_esmControl_r1i1p1_135101-135212.nc');                      % CDF file from Lamont website does not contain lat and lon variables. 'pathname_coord' file downloaded from ESGF website to obtain these variables.
% 
% 
...
load piControlData/NOR_ESM1m_ME/NOR_ESM1m_ME_windstress.mat
load lat_lon.mat
