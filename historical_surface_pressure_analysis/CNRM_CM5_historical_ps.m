function [time_year, sam_DJF, sam_trend_30, sam_trend, begin_time, end_time] = CNRM_CM5_historical_ps
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

%% Import Data
current_path = pwd;
pathname_ps = fullfile(current_path,'HistoricalData/CNRM_CM5_historical_r1i1p1_ps.cdf');
