function [time_year, sam_DJF, sam_trend_30, sam_trend, begin_time, end_time] = NOR_ESM1m_ME_historical_ps
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

%% Import Data
current_path = pwd;
pathname_ps = fullfile(current_path,'/HistoricalData/NOR_ESM1m_ME_historical_r1i1p1_ps.cdf');
