function [time_year, sam_DJF, sam_trend_30, sam_trend, begin_time, end_time] = GFDL_ESM2G_historical_ps
...
current_path = pwd;
pathname_ps = fullfile(current_path,'HistoricalData/GFDL_ESM2G_historical_r1i1p1_ps.cdf');
