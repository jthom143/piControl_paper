...
print -depsc CAN_ESM2_wind_jet_pdf
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc CCSM4_wind_jet_pdf
% 
% close all
% clear all
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc CMCC_CESM_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc CMCC_CMs_wind_jet_pdf
% 
% close all
% clear all
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CNRM_CM5_wind_jet_pdf
...
print -depsc CNRM_CM5_2_wind_jet_pdf
...
ylabel('Probability Density')
legend([h1, h3], 'Pi-control PDF', 'Renanalysis 1 Trend')
print -depsc GFDL_ESM2G_wind_jet_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc GFDL_ESM2M_wind_jet_pdf
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc IPSL_CM5a_LR_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc IPSL_CM5a_MR_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc IPSL_CM5b_LR_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc MIROC5_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc MIROC_ESM_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc MIROC_ESM_CHEM_wind_jet_pdf
% 
% close all
% clear all
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MPI_ESM_LR_wind_jet_pdf
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc MPI_ESM_MR_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc MRI_CGCM3_wind_jet_pdf
% 
% close all
% clear all
% 
...
% ylabel('Probability Density')
% legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
% print -depsc NOR_ESM1m_ME_wind_jet_pdf
% 
% close all
% clear all