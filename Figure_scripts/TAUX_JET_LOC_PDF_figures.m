...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CCSM4_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CMCC_CESM_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CMCC_CMs_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CMCC_CM_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc CNRM_CM5_taux_jet_loc_pdf
...
print -depsc CNRM_CM5_2_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h3], 'Pi-control PDF', 'Renanalysis 1 Trend')
print -depsc GFDL_ESM2G_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc GFDL_ESM2M_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc IPSL_CM5a_LR_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc IPSL_CM5a_MR_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc IPSL_CM5b_LR_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MIROC5_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MIROC_ESM_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MIROC_ESM_CHEM_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MPI_ESM_LR_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MPI_ESM_MR_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc MRI_CGCM3_taux_jet_loc_pdf
...
ylabel('Probability Density')
legend([h1, h2, h3], 'Pi-control PDF', 'Historical Run Trend', 'Renanalysis 1 Trend')
print -depsc NOR_ESM1m_ME_taux_jet_loc_pdf
