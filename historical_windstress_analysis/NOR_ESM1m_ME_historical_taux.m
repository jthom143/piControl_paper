function [ time_year, jet_DJF, lat_jet_DJF, jet_trend, jet_trend_30, jet_loc_trend, jet_loc_trend_30 ] = NOR_ESM1m_ME_historical_taux

%NOR_ESM1M_ME_historical_taux loads in the windstress data for the NOR_ESM1m_ME historical ensemble 1 model run and calculates the westerly wind jet and location and then calcuates the trend pdfs for these two variables. 

%% Import Data
current_path = pwd;
pathname_taux = fullfile(current_path, 'HistoricalData/NOR_ESM1M_ME_historical_r1i1p1_tauu.cdf');     % CDF file from Lamont website
