function [ time_year, jet_DJF, lat_jet_DJF, jet_trend, jet_trend_30, jet_loc_trend, jet_loc_trend_30 ] = IPSL_CM5b_LR_historical_taux

%IPSL_CM5b_LR_historical_taux loads in the windstress data for the IPSL CM5b LR historical ensemble 1 model run and calculates the westerly wind jet and location and then calcuates the trend pdfs for these two variables. 

%% Import Data
current_path = pwd;
pathname_taux = fullfile(current_path, 'HistoricalData/IPSL_CM5b_LR_historical_r1i1p1_tauu.cdf');     % CDF file from Lamont website
