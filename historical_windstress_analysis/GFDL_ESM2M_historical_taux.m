function [ time_year, jet_DJF, lat_jet_DJF, jet_trend, jet_trend_30, jet_loc_trend, jet_loc_trend_30 ] = GFDL_ESM2M_historical_taux

%GFDL_ESM2M_historical_taux loads in the windstress data for the GFDL_ESM2M historical ensemble 1 model run and calculates the westerly wind jet and location and then calcuates the trend pdfs for these two variables. 

%% Import Data
current_path = pwd;
pathname_taux = fullfile(current_path, 'HistoricalData/GFDL_ESM2M_historical_r1i1p1_tauu.cdf');     % CDF file from Lamont website
