...
begin_time = [can_esm2_time_year(1)                         , ccsm4_time_year(1)                      , cmcc_cesm_time_year(1)                          , cmcc_cm_time_year(1)                        , cmcc_cms_time_year(1)                        , cnrm_cm5_time_year(1)                         , gfdl_esm2g_time_year(1)                           , gfdl_esm2m_time_year(1)                           , ipsl_cm5a_lr_time_year(1)                             , ipsl_cm5a_mr_time_year(1)                             , ipsl_cm5b_lr_time_year(1)                             , miroc_esm_time_year(1)                          , miroc_esm_chem_time_year(1)                               , miroc5_time_year(1)                       , mpi_esm_lr_time_year(1)                           , mpi_esm_mr_time_year(1)                           , mri_cgcm3_time_year(1)                          , nor_esm1m_me_time_year(1)                                ]';
end_time =   [can_esm2_time_year(length(can_esm2_time_year)), ccsm4_time_year(length(ccsm4_time_year)), cmcc_cesm_time_year(length(cmcc_cesm_time_year)), cmcc_cm_time_year(length(cmcc_cm_time_year)), cmcc_cms_time_year(length(cmcc_cm_time_year)), cnrm_cm5_time_year(length(cnrm_cm5_time_year)), gfdl_esm2g_time_year(length(gfdl_esm2g_time_year)), gfdl_esm2m_time_year(length(gfdl_esm2m_time_year)), ipsl_cm5a_lr_time_year(length(ipsl_cm5a_lr_time_year)), ipsl_cm5a_mr_time_year(length(ipsl_cm5a_mr_time_year)), ipsl_cm5b_lr_time_year(length(ipsl_cm5a_lr_time_year)), miroc_esm_time_year(length(miroc_esm_time_year)), miroc_esm_chem_time_year(length(miroc_esm_chem_time_year)), miroc5_time_year(length(miroc5_time_year)), mpi_esm_lr_time_year(length(mpi_esm_lr_time_year)), mpi_esm_mr_time_year(length(mpi_esm_mr_time_year)), mri_cgcm3_time_year(length(mri_cgcm3_time_year)), nor_esm1m_me_time_year(length(nor_esm1m_me_time_year))   ]';

begin_time = [can_esm2_time_year(1)                         , cnrm_cm5_time_year(1)                         , gfdl_esm2g_time_year(1)                           , gfdl_esm2m_time_year(1)]';
end_time =   [can_esm2_time_year(length(can_esm2_time_year)), cnrm_cm5_time_year(length(cnrm_cm5_time_year)), gfdl_esm2g_time_year(length(gfdl_esm2g_time_year)), gfdl_esm2m_time_year(length(gfdl_esm2m_time_year))]';
