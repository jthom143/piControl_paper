function [ sam_f, sam_xi, mean_sam, std_sam, time_year, SAM_unnormalized, sam_trends_yrs ] = CanESM2_seasonal(Type)

%% Import Data

current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/CanESM2/CanESM2_ps.cdf');
