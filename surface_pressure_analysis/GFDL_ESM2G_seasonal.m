function [ sam_f, sam_xi, mean_sam, std_sam, time_year, SAM_unnormalized, sam_trends_yrs ] = GFDL_ESM2G_seasonal(Type)
...
current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/GFDL_ESM2G/GFDL_ESM2G_ps.cdf');
