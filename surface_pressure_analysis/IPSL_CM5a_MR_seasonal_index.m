function [ sam_f, sam_xi, mean_sam, std_sam, time_year, sam_DJF, sam_trends_yrs ] = IPSL_CM5a_MR_seasonal_index(Type)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

%% Import Data
current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/IPSL_CM5a_MR/IPSL_CM5a_MR_ps.cdf');
