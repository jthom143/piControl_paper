function [ sam_f, sam_xi, mean_sam, std_sam, time_year, sam_DJF, sam_trends_yrs ] = CCSM4_seasonal_index(Type)
...
current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/CCSM4/CCSM4_ps.cdf');
