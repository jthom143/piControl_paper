function [ sam_f, sam_xi, mean_sam, std_sam, time_year, SAM_unnormalized, sam_trends_yrs ] = GFDL_ESM2M_seasonal(Type)
...
current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/GFDL_ESM2M/GFDL_ESM2M_ps.cdf');
