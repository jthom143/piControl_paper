function [ jet_f, jet_xi, mean_jet, std_jet, jet_trends_yrs, jet_loc_f, jet_loc_xi, mean_jet_loc, std_jet_loc, jet_loc_trends_yrs, time_year, jet_DJF, lat_jet_DJF ] = GFDL_ESM2M_u850_seasonal(Type)


%% Import Data

current_path = pwd;
pathname_u850 = fullfile(current_path, 'piControlData/GFDL_ESM2M/GFDL_ESM2M_u850.cdf');     % CDF file from Lamont website
