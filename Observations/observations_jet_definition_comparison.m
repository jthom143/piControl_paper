...
set(get(AX_r1(2),'Ylabel'),'String','Wind stress (Pa)', 'fontsize', fsz) 
xlabel('Time (years)')
title('Jet Magnitude defined by wind stress and 850mb winds', 'fontsize', fsz)
...
hold on
h2 = plot(1980:(1/4):2006, r1_taux_lat_jet_DJF_smoothed, 'linewidth', lw, 'color', [0,0,1], 'linestyle', '- -');
h3 = plot(1980:(1/4):2006, r2_u850_lat_jet_DJF_smoothed, 'linewidth', lw, 'color', [0,204/255,0]);
h4 = plot(1980:(1/4):2006, r2_taux_lat_jet_DJF_smoothed, 'linewidth', lw, 'color', [0,204/255,0], 'linestyle', '- -');
h5 = plot(1980:(1/4):2006, era_u850_lat_jet_DJF_smoothed, 'linewidth', lw, 'color', [1,0,0]);
h6 = plot(1980:(1/4):2006, era_taux_lat_jet_DJF_smoothed, 'linewidth', lw, 'color', [1,0,0], 'linestyle', '- -');
xlim([1980 2010])
set(gca, 'fontsize', fsz)
ylabel('Latitude (Degrees)')
xlabel('Time (years)')
title('Jet Location defined by wind stress and 850mb winds', 'fontsize', fsz)
